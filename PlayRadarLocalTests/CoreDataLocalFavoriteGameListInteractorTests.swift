//
//  CoreDataLocalFavoriteGameListInteractorTests.swift
//  PlayRadarLocalTests
//
...
class CoreDataLocalFavoriteGameListInteractorTests: XCTestCase {

    var spyClient: SpyDatabaseClient!
    var interactor: CoreDataLocalFavoriteGameListInteractor!

    override func setUp() {
        super.setUp()
        spyClient = SpyDatabaseClient(spied: CoreDataDatabase.shared)
        interactor = CoreDataLocalFavoriteGameListInteractor(databaseClient: spyClient)
    }
